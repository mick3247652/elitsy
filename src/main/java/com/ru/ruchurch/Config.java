...
public final class Config {
    ...
    public static final Jid BUG_REPORTS = Jid.of("mick@ruchurch.icu");


    public static final String DOMAIN_LOCK = "ruchurch.icu"; //only allow account creation for this domain
    public static final String MAGIC_CREATE_DOMAIN = "ruchurch.icu";
    public static final String QUICKSY_DOMAIN = "ruchurch.icu";
